  ...
  <div>
      ...
      <div class="container marginTop20">
        <div class="row marginCol">
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/11.jpg" alt="" class="img-responsive"/>
                <span class="intro1">
                    <h2>独具匠心1</h2>
                    <p>纯手工打造</p>
                </span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/12.jpg" alt=""  class="img-responsive"/>
                <span class="intro1">
                    <h2>独具匠心2</h2>
                    <p>纯手工打造</p>
                </span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/13.jpg" alt=""  class="img-responsive"/>
                <span class="intro1">
                    <h2>独具匠心3</h2>
                    <p>纯手工打造</p>
                </span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/14.jpg" alt="" class="img-responsive" />
                <span class="intro1">
                    <h2>独具匠心4</h2>
                    <p>纯手工打造</p>
                </span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/15.jpg" alt="" class="img-responsive" />
                <span class="intro1">
                    <h2>独具匠心5</h2>
                    <p>纯手工打造</p>
                </span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/16.jpg" alt="" class="img-responsive"/>
                <span class="intro1">
                    <h2>独具匠心6</h2>
                    <p>纯手工打造</p>
                </span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 example1">
                <img src="../assets/img/history/19.jpg" alt="" class="img-responsive"/>
                <span class="intro1">
                    <h2>独具匠心9</h2>
                    <p>纯手工打造</p>
                </span>
        ...
        mounted(){
            	function sHover(itemClass,introClass){
                    ...
                    for (var i = 0; i < sItemArr.length; i++) {
                        ...
                        sIntro.style.height=2*thisItem.size.height+"px";
                ...
                var expamle1 = new sHover("example1","intro1");
                expamle1.set({
                    speed:7,
                    opacity:80,
                    opacityChange:true
